...
(for ([i (in-range max)])
  (define k (bf i))
  (define y (bf/ (bf* (bffactorial (bigfloat->real (bf* b6 k))) (bf+ b13591409 (bf* b545140134 k)))
       (bf* (bffactorial (bigfloat->real (bf* b3 k))) (bfexpt (bffactorial (bigfloat->real k)) b3) (bfexpt b-640320 (bf* b3 k )))))
